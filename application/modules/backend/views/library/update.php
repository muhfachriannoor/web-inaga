...
<div class="content-wrapper">
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Change Library</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">Home</a></li>
            <li class="breadcrumb-item active">Change Library</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
      ...
      <div class="row">
        <div class="col-md-12">
            <div class="card card-primary">
              ...
              <form action="<?= site_url('backend/library/'.$sub_menunya.'/update/down/'.$datanya->id_library);?>" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <?php else: ?>
                    <div class="form-group">
                      ...
                      <input type="text" name="nama_library" class="form-control" required="required" placeholder="Fill in the Name library..." value="<?= $datanya->nama_library;?>">
                    </div>
                  <?php endif; ?>
                  <?php if(form_error('kategori_library') == TRUE): ?>
                    <div class="form-group">
                      ...
                      <input type="text" name="kategori_library" class="form-control is-warning" required="required" placeholder="Fill in the Category..." id="inputWarning" value="<?= $datanya->kategori_library;?>" readonly="readonly" style="background-color: #cccaca;">
                    </div>
                  <?php else: ?>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Category</label>
                      <input type="text" name="kategori_library" class="form-control" required="required" placeholder="Fill in the Category..." value="<?= $datanya->kategori_library;?>" readonly="readonly" style="background-color: #cccaca;">
                    </div>
                  <?php endif; ?>
                  ...
                  <?php else: ?>
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" name="tanggal_library" class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="mm/dd/yyyy" data-mask value="<?= date('m/d/Y',strtotime($datanya->tanggal_library));?>">
                      </div>
                    </div>
                  <?php endif; ?>
                  <?php if($foto_error == TRUE OR form_error('foto_library') == TRUE): ?>
                    <div class="form-group">
                      ...
                      <input type="file" name="foto_library" class="form-control is-warning">
                    </div>
                  <?php else: ?>
                    <div class="form-group">
                      <label>Picture&nbsp;&nbsp;<code>Minimum 200 x 250</code></label>
                      <input type="file" name="foto_library" class="form-control">
                    </div>
                  <?php endif; ?>
                  <?php if($pdf_error == TRUE OR form_error('pdf_library') == TRUE): ?>
                    <div class="form-group">
                      ...
                      <input type="file" name="pdf_library" class="form-control is-warning">
                    </div>
                  <?php else: ?>
                    <div class="form-group">
                      <label>File&nbsp;&nbsp;<code>*pdf</code></label>
                      <input type="file" name="pdf_library" class="form-control">
                    </div>
                  <?php endif; ?>
                </div>
