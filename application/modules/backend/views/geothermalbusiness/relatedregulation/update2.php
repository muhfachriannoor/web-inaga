      ...
      <div class="row">
        <div class="col-md-12">
            <div class="card card-primary">
              ...
              <form action="<?= site_url('backend/geothermalbusiness/relatedregulation/category/update/down/'.$datanya->id_kategori_geothermal);?>" method="post" enctype="multipart/form-data">
                <?php if($error == TRUE): ?>
