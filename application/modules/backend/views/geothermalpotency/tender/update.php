      ...
      <div class="row">
        <div class="col-md-12">
            <div class="card card-primary">
              ...
              <form action="<?= site_url('backend/geothermalpotency/workingarea/tender/update/down/'.$datanya->id_tender);?>" method="post" enctype="multipart/form-data">
                <?php if($error == TRUE): ?>
                ...
                <div class="card-body">
                  ...
                  <?php else: ?>
                    <div class="form-group">
                      ...
                      <input type="text" name="location"  class="form-control" required="required" placeholder="Fill in the District Location.." value="<?= $datanya->location;?>">
                    </div>
                  <?php endif; ?>
                  ...
                  <?php else: ?>
                    <div class="form-group">
                      <label>Potency</label>
                      <input type="number" name="potency"  class="form-control" required="required" placeholder="00" value="<?= $datanya->potency;?>">
                    </div>
                  <?php endif; ?>
                  ...
                  <?php else: ?>
                    <div class="form-group">
                      ...
                      <input type="number" name="development_plan"  class="form-control" required="required" placeholder="00" value="<?= $datanya->development_plan;?>">
                    </div>
                  <?php endif; ?>
                </div>
