      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Add Student Chapter</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
      ...
      <div class="row">
        <div class="col-md-12">
            <div class="card card-primary">
              ...
              <form action="<?= site_url('backend/association/studentchapter/create/up');?>" method="post" enctype="multipart/form-data">
                <?php if($error == TRUE): ?>
                ...
                <div class="card-body">
                  ...
                  <?php else: ?>
                    <div class="form-group">
                      ...
                      <input type="text" name="nama_student" class="form-control" required="required" placeholder="Fill in the Name student..." value="<?= set_value('nama_student');?>">
                    </div>
                  <?php endif; ?>
                  ...
                  <?php else: ?>
                    <div class="form-group">
                      ...
                      <textarea id="textarea" name="deskripsi_student" rows="10" cols="80" required="required" placeholder="Isi Text...."><?= set_value('deskripsi_student');?></textarea>
                    </div>
                  <?php endif; ?>
                  <?php if($error == TRUE OR form_error('foto_student') == TRUE): ?>
                    <div class="form-group">
                      ...
                      <input type="file" name="foto_student" class="form-control is-warning" required="required">
                    </div>
                  <?php else: ?>
                    <div class="form-group">
                      <label>Picture&nbsp;&nbsp;<code>Minimum 300 x 300</code></label>
                      <input type="file" name="foto_student" class="form-control" required="required">
                    </div>
                  <?php endif; ?>
                </div>
