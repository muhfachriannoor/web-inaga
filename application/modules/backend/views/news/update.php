      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Change News</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
      ...
      <div class="row">
        <div class="col-md-12">
            <div class="card card-primary">
              ...
              <form action="<?= site_url('backend/news/update/down/'.$datanya->id_berita);?>" method="post" enctype="multipart/form-data">
                <?php if($error == TRUE): ?>
                ...
                <div class="card-body">
                  ...
                  <?php else: ?>
                    <div class="form-group">
                      ...
                      <input type="text" name="judul_berita" class="form-control" required="required" placeholder="Fill in the Title news..." value="<?= $datanya->judul_berita;?>">
                    </div>
                  <?php endif; ?>
                  ...
                  <?php else: ?>
                    <div class="form-group">
                      ...
                      <input type="text" name="penulis" class="form-control" required="required" placeholder="Fill in the Author..." value="<?= $datanya->penulis;?>">
                    </div>
                  <?php endif; ?>
                  <?php if($error == TRUE OR form_error('foto_berita') == TRUE): ?>
                    <div class="form-group">
                      ...
                      <input type="file" name="foto_berita" class="form-control is-warning">
                    </div>
                  <?php else: ?>
                    <div class="form-group">
                  ...
                  <?php if(form_error('text_berita') == TRUE): ?>
                    <div class="form-group">
                      ...
                      <textarea id="textarea" name="text_berita" class="form-control is-warning" rows="10" cols="80" required="required" placeholder="Isi Text...."><?= $datanya->text_berita;?></textarea>
                    </div>
                  <?php else: ?>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Text</label>
                      <textarea id="textarea" name="text_berita" rows="10" cols="80" required="required" placeholder="Isi Text...."><?= $datanya->text_berita;?></textarea>
                    </div>
                  <?php endif; ?>
                </div>
