      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Change NZTE Directory</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
      ...
      <div class="row">
        <div class="col-md-12">
            <div class="card card-primary">
              ...
              <form action="<?= site_url('backend/nzte/directory/update/down/'.$datanya->id_directory);?>" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <?php else: ?>
                    <div class="form-group">
                      ...
                      <input type="text" name="company_name" class="form-control" required="required" placeholder="Fill in the Company name..." value="<?= $datanya->company_name;?>">
                    </div>
                  <?php endif; ?>
                  ...
                  <?php else: ?>
                    <div class="form-group">
                      ...
                      <input type="text" name="website" class="form-control" required="required" placeholder="Fill in the Link Website..." value="<?= $datanya->website;?>">
                    </div>
                  <?php endif; ?>
                  ...
                  <?php else: ?>
                    <div class="form-group">
                      ...
                      <input type="text" name="contact_name" class="form-control" required="required" placeholder="Fill in the Contact name..." value="<?= $datanya->contact_name;?>">
                    </div>
                  <?php endif; ?>
                  ...
                  <?php else: ?>
                    <div class="form-group">
                      ...
                      <input type="text" name="contact_position" class="form-control" placeholder="Fill in the Contact Position..." value="<?= $datanya->contact_position;?>">
                    </div>
                  <?php endif; ?>
                  ...
                  <?php else: ?>
                    <div class="form-group">
                      ...
                      <input type="number" name="contact_number" class="form-control" required="required" placeholder="Fill in the Contact number..." value="<?= $datanya->contact_number;?>">
                    </div>
                  <?php endif; ?>
                  ...
                  <?php else: ?>
                    <div class="form-group">
                      ...
                      <input type="email" name="contact_email" class="form-control" required="required" placeholder="your@email.com" value="<?= $datanya->contact_email;?>">
                    </div>
                  <?php endif; ?>
                  ...
                  <?php if($logo_error == TRUE OR form_error('logo') == TRUE): ?>
                    <div class="form-group">
                      ...
                      <input type="file" name="logo" class="form-control is-warning">
                    </div>
                  <?php else: ?>
                    <div class="form-group">
