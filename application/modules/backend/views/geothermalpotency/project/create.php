      ...
      <div class="row">
        <div class="col-md-12">
            <div class="card card-primary">
              ...
              <form action="<?= site_url('backend/geothermalpotency/workingarea/project/create/up');?>" method="post" enctype="multipart/form-data">
                <?php if($error == TRUE): ?>
                ...
                <div class="card-body">
                  ...
                  <?php else: ?>
                    <div class="form-group">
                      ...
                      <div id="developer_project">
                        <input type="text" name="developer"  class="form-control" required="required" placeholder="Fill in the Developer.." value="<?= set_value('developer');?>" readonly="readonly">
                      </div>
                    </div>
                  <?php endif; ?>
