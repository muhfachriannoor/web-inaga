      ...
      <div class="row">
        <div class="col-md-12">
            <div class="card card-primary">
              ...
              <form action="<?= site_url('backend/geothermalpotency/main/create/up');?>" method="post" enctype="multipart/form-data">
                <?php if($error == TRUE): ?>
                ...
                <div class="card-body">
                  <?php if($error == TRUE OR form_error('foto_map') == TRUE): ?>
                    <div class="form-group">
                      ...
                      <input type="file" name="foto_map" class="form-control is-warning" required="required">
                    </div>
                  <?php else: ?>
                    <div class="form-group">
                      <label>Map Image</label>
                      <input type="file" name="foto_map" class="form-control" required="required">
                    </div>
                  <?php endif; ?>
                  ...
                  <?php else: ?>
                    <div class="form-group">
                      ...
                      <textarea id="textarea" name="text_overview_resources" rows="10" cols="80" required="required" placeholder="Isi Text...."><?= set_value('text_overview_resources');?></textarea>
                    </div>
                  <?php endif; ?>
                  ...
                  <?php else: ?>
                    <div class="form-group">
                      ...
                      <textarea id="textarea2" name="text_overview_workingarea" rows="10" cols="80" required="required" placeholder="Isi Text...."><?= set_value('text_overview_workingarea');?></textarea>
                    </div>
                  <?php endif; ?>
                </div>
