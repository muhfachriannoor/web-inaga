      ...
      <div class="row">
        <div class="col-md-12">
            <div class="card card-primary">
              ...
              <form action="<?= site_url('backend/association/aboutus/objective/create/up');?>" method="post" enctype="multipart/form-data">
                <?php if($error == TRUE): ?>
                ...
                <div class="card-body">
                  ...
                  <?php else: ?>
                    <div class="form-group">
                      ...
                      <textarea id="textarea" name="text_objective" rows="10" cols="80" required="required" placeholder="Isi Text...."><?= set_value('text_objective');?></textarea>
                    </div>
                  <?php endif; ?>
                </div>
