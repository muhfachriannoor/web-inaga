...
<div class="content-wrapper">
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Change Geothermal Regulation</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Change Geothermal Regulation</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
      ...
      <div class="row">
        <div class="col-md-12">
            <div class="card card-primary">
              ...
              <form action="<?= site_url('backend/geothermalbusiness/geothermalregulation/update/down/'.$datanya->id_geothermal_regulation);?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <select name="id_kategori_geothermal" class="form-control select2" required="required">
                        ...
                        <?php
                          ...
                          foreach($category->result() as $no => $category):
                        ?>
                        <option <?= ($datanya->id_kategori_geothermal == $category->id_kategori_geothermal) ? 'selected="selected"' : '';?> value="<?= $category->id_kategori_geothermal;?>"><?= $category->nama_kategori;?></option>
                        <?php endforeach; ?>
                      </select>
                    </div>
                  <?php endif; ?>
