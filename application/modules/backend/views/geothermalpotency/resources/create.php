      ...
      <div class="row">
        <div class="col-md-12">
            <div class="card card-primary">
              ...
              <form action="<?= site_url('backend/geothermalpotency/resources/island/'.$island.'/create/up');?>" method="post" enctype="multipart/form-data">
                <?php if($error == TRUE): ?>
                ...
                <div class="card-body">
                  ...
                  <?php else: ?>
                    <div class="form-group">
                      ...
                      <input type="text" name="index_no" class="form-control" required="required" placeholder="Fill in the Index No..." value="<?= set_value('index_no');?>">
                    </div>
                  <?php endif; ?>
                  ...
                  <?php else: ?>
                    <div class="form-group">
                      ...
                      <input type="text" name="field_name" class="form-control" required="required" placeholder="Fill in the Field Name.." value="<?= set_value('field_name');?>">
                    </div>
                  <?php endif; ?>
                  ...
                  <?php else: ?>
                    <div class="form-group">
                      <label>Status</label>
                      <input type="text" name="status" class="form-control" required="required" placeholder="Fill in the Status.." value="<?= set_value('status');?>">
                    </div>
                  <?php endif; ?>
                </div>
