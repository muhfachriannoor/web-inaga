      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Change Vision & Mission</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
      ...
      <div class="row">
        <div class="col-md-12">
            <div class="card card-primary">
              ...
              <form action="<?= site_url('backend/association/aboutus/visionmission/update/down/'.$datanya->id_visi);?>" method="post" enctype="multipart/form-data">
                <?php if($error == TRUE): ?>
                ...
                <div class="card-body">
                  ...
                  <?php else: ?>
                    <div class="form-group">
                      ...
                      <textarea id="textarea" name="visimisi" rows="10" cols="80" required="required" placeholder="Isi Vision & Mission...."><?= $datanya->visimisi;?></textarea>
                    </div>
                  <?php endif; ?>
                </div>
