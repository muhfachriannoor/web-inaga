      ...
      <div class="row">
        <div class="col-md-12">
            <div class="card card-primary">
              ...
              <form action="<?= site_url('backend/geothermalbusiness/main/update/down/'.$datanya->id_business);?>" method="post" enctype="multipart/form-data">
                <?php if($error == TRUE): ?>
                ...
                <div class="card-body">
                  ...
                  <?php else: ?>
                    <div class="form-group">
                      ...
                      <textarea id="textarea2" name="description_business" rows="10" cols="80" required="required" placeholder="Isi Text...."><?= $datanya->description_business;?></textarea>
                    </div>
                  <?php endif; ?>
                </div>
