      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Change President API</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
      ...
      <div class="row">
        <div class="col-md-12">
            <div class="card card-primary">
              ...
              <form action="<?= site_url('backend/association/aboutus/president/update/down/'.$datanya->id_president);?>" method="post" enctype="multipart/form-data">
                <?php if($error == TRUE): ?>
                ...
                <div class="card-body">
                  ...
                  <?php else: ?>
                    <div class="form-group">
                      ...
                      <input type="text" name="nama" class="form-control" required="required" placeholder="Fill in the Name..." value="<?= $datanya->nama_president;?>">
                    </div>
                  <?php endif; ?>
                  ...
                  <?php else: ?>
                    <div class="form-group">
                      ...
                      <input type="text" name="masa_jabatan" class="form-control" required="required" placeholder="Fill in the Term of office..." value="<?= $datanya->masa_jabatan;?>">
                    </div>
                  <?php endif; ?>
                  <?php if($error == TRUE OR form_error('foto_president') == TRUE): ?>
                    <div class="form-group">
                      ...
                      <input type="file" name="foto_president" class="form-control is-warning">
                    </div>
                  <?php else: ?>
                    <div class="form-group">
                      <label>Picture&nbsp;&nbsp;<code>Minimum 300 x 300</code></label>
                      <input type="file" name="foto_president" class="form-control">
                    </div>
                  <?php endif; ?>
                </div>
