      ...
      <div class="row">
        <div class="col-md-12">
            <div class="card card-primary">
              ...
              <form action="<?= site_url('backend/geothermalbusiness/stakeholder-overview/update/down/'.$datanya->id_stakeholder_overview);?>" method="post" enctype="multipart/form-data">
                <?php if($error == TRUE): ?>
                ...
                <div class="card-body">
                  ...
                  <?php else: ?>
                    <div class="form-group">
                      ...
                      <textarea id="textarea" name="text_overview" rows="10" cols="80" required="required" placeholder="Isi Text...."><?= $datanya->text_overview;?></textarea>
                    </div>
                  <?php endif; ?>
