      ...
      <div class="row">
        <div class="col-md-12">
            <div class="card card-primary">
              ...
              <form action="<?= site_url('backend/eventgallery/gallery/create/up');?>" method="post" enctype="multipart/form-data">
                <?php if($error == TRUE): ?>
                ...
                <div class="card-body">
                  ...
                  <?php else: ?>
                    <div class="form-group">
                      ...
                      <input type="text" name="nama_galeri" class="form-control" required="required" placeholder="Fill in the Name gallery..." value="<?= set_value('nama_galeri');?>">
                    </div>
                  <?php endif; ?>
                  ...
                  <?php else: ?>
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        ...
                        <input type="text" name="tanggal_galeri" class="form-control" data-inputmask-alias="datetime" data-inputmask-inputformat="mm/dd/yyyy" data-mask value="<?= set_value('tanggal_galeri');?>">
                      </div>
                    </div>
                  <?php endif; ?>
                  <?php if($error == TRUE OR form_error('foto_galeri') == TRUE): ?>
                    <div class="form-group">
                      ...
                      <input type="file" name="foto_galeri" class="form-control is-warning" required="required">
                    </div>
                  <?php else: ?>
                    <div class="form-group">
