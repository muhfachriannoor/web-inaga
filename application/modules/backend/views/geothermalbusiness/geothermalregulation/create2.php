      ...
      <div class="row">
        <div class="col-md-12">
            <div class="card card-primary">
              ...
              <form action="<?= site_url('backend/geothermalbusiness/geothermalregulation/category/create/up');?>" method="post" enctype="multipart/form-data">
                <?php if($error == TRUE): ?>
                ...
                <div class="card-body">
                  ...
                  <?php else: ?>
                    <div class="form-group">
                      ...
                      <input type="text" name="nama_kategori" class="form-control" required="required" placeholder="Fill in the name of the category..." value="<?= set_value('nama_kategori');?>">
                    </div>
                  <?php endif; ?>
                </div>
