      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Change Member</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
      ...
      <div class="row">
        <div class="col-md-12">
            <div class="card card-primary">
              ...
              <form action="<?= site_url('backend/association/member/update/down/'.$datanya->id_member);?>" method="post" enctype="multipart/form-data">
                <?php if($error == TRUE): ?>
                ...
                <div class="card-body">
                  ...
                  <?php else: ?>
                    <div class="form-group">
                      ...
                      <input type="text" name="nama_member" class="form-control" required="required" placeholder="Fill in the Name member..." value="<?= $datanya->nama_member;?>">
                    </div>
                  <?php endif; ?>
                  ...
                  <?php else: ?>
                    <div class="form-group">
                      ...
                      <textarea id="textarea" name="deskripsi_member" rows="10" cols="80" required="required" placeholder="Isi Text...."><?= $datanya->deskripsi_member;?></textarea>
                    </div>
                  <?php endif; ?>
                  <?php if($error == TRUE OR form_error('foto_member') == TRUE): ?>
                    <div class="form-group">
                      ...
                      <input type="file" name="foto_member" class="form-control is-warning">
                    </div>
                  <?php else: ?>
                    <div class="form-group">
