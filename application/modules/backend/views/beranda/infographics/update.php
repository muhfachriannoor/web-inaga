...
<div class="content-wrapper">
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Change Info Graphics</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">Home</a></li>
            <li class="breadcrumb-item active">Change Info Graphics</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
      ...
      <div class="row">
        <div class="col-md-12">
            <div class="card card-primary">
              ...
              <form action="<?= site_url('backend/beranda/infographics/update/down/'.$datanya->id_infografis);?>" method="post" enctype="multipart/form-data">
                <?php if($error == TRUE): ?>
                ...
                <div class="card-body">
                  ...
                  <?php else: ?>
                    <div class="form-group">
                      ...
                      <input type="text" name="nama_infografis" class="form-control" required="required" placeholder="Fill in the Name info graphics..." value="<?= $datanya->nama_infografis;?>">
                    </div>
                  <?php endif; ?>
                  <?php if($error == TRUE OR form_error('foto_infografis') == TRUE): ?>
                    <div class="form-group">
                      ...
                      <input type="file" name="foto_infografis" class="form-control is-warning">
                    </div>
                  <?php else: ?>
                    <div class="form-group">
                      <label>Picture&nbsp;&nbsp;<code>Minimum 400 x 400</code></label>
                      <input type="file" name="foto_infografis" class="form-control">
                    </div>
                  <?php endif; ?>
                </div>
