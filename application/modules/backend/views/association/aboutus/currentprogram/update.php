      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-7">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Change Current Program</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
      ...
      <div class="row">
        <div class="col-md-12">
            <div class="card card-primary">
              ...
              <form action="<?= site_url('backend/association/aboutus/currentprogram/update/down/'.$datanya->id_current);?>" method="post" enctype="multipart/form-data">
                <?php if($error == TRUE): ?>
                ...
                <div class="card-body">
                  ...
                  <?php else: ?>
                    <div class="form-group">
                      ...
                      <textarea id="textarea" name="currentprogram" rows="10" cols="80" required="required" placeholder="Isi Text...."><?= $datanya->text_current;?></textarea>
                    </div>
                  <?php endif; ?>
                </div>
