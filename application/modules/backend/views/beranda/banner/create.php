      ...
      <div class="row">
        <div class="col-md-12">
            <div class="card card-primary">
              ...
              <form action="<?= site_url('backend/beranda/banner/create/up');?>" method="post" enctype="multipart/form-data">
                <?php if($error == TRUE): ?>
                ...
                <div class="card-body">
                  ...
                  <?php else: ?>
                    <div class="form-group">
                      ...
                      <input type="text" name="judul_banner" class="form-control" required="required" placeholder="Fill in the title banner..." value="<?= set_value('judul_banner');?>">
                    </div>
                  <?php endif; ?>
                  ...
                  <?php else: ?>
                    <div class="form-group">
                      ...
                      <textarea id="textarea" name="text_banner" rows="10" cols="80" required="required" placeholder="Isi Text...."><?= set_value('text_banner');?></textarea>
                    </div>
                  <?php endif; ?>
                  <?php if($error == TRUE OR form_error('foto_banner') == TRUE): ?>
                    <div class="form-group">
                      ...
                      <input type="file" name="foto_banner" class="form-control is-warning" required="required">
                    </div>
                  <?php else: ?>
                    <div class="form-group">
                      <label>Picture&nbsp;&nbsp;<code>Minimum 1280 x 720</code></label>
                      <input type="file" name="foto_banner" class="form-control" required="required">
                    </div>
                  <?php endif; ?>
                </div>
